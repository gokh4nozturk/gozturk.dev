...
export const summary = {
  text: "Software Engineer with 5+ years building and shipping web products end-to-end. Comfortable across the stack — Vue/React on the frontend, serverless backends on Cloudflare Workers and Postgres. Ship-focused: own features from spec to production and build my own SaaS products on the side.",
};
...
export const experience = [
  {
    achievements: [
      ...
      "Led a full frontend rewrite of Rockads, moving from an in-house atomic-design component library to a leaner shadcn-vue setup — boosting performance and increasing feature delivery speed by ~30%, backed by CI pipelines and test coverage for reliable releases",
    ...
    techStack: "Vue 3, TypeScript, shadcn-vue, Tailwind CSS, Vitest, GitHub Actions",
    title: "Software Engineer",
  },
  {
    achievements: [
